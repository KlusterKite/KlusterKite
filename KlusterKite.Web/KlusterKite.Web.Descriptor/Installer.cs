...
namespace KlusterKite.Web.Descriptor
{
    ...
    public class Installer : BaseInstaller
    {
        ...
        protected override Config GetAkkaConfig() => ConfigurationFactory.ParseString(ReadTextResource(typeof(Installer).GetTypeInfo().Assembly, "KlusterKite.Web.Descriptor.Resources.akka.hocon"));
