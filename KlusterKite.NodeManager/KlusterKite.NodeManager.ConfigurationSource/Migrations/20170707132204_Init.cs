                ...
                constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            name: "FK_CompatibleTemplate_Configurations_CompatibleReleaseId",
                            column: x => x.CompatibleReleaseId,
                            principalTable: "Configurations",
                            principalColumn: "Id",
                            onDelete: ReferentialAction.Cascade);
                        table.ForeignKey(
                            name: "FK_CompatibleTemplate_Configurations_ReleaseId",
                ...
                constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            name: "FK_MigrationLogRecords_Configurations_ReleaseId",
                            column: x => x.ReleaseId,
                            principalTable: "Configurations",
                            principalColumn: "Id",
                            onDelete: ReferentialAction.Cascade);
