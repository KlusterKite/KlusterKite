...
let projects = [|
    ...
    new ProjectDescription("ClusterKit.Web", "./ClusterKit.Web/ClusterKit.Web.Authentication/ClusterKit.Web.Authentication.csproj", ProjectDescription.EnProjectType.NugetPackage, ([|"ClusterKit.Core"; "ClusterKit.Web.Client"; "ClusterKit.Web.Descriptor"; "ClusterKit.Web"; "ClusterKit.Security.Client"|]))
