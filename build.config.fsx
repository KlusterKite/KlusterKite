...
let projects = [|
    ...
    new ProjectDescription("ClusterKit.Data", "./ClusterKit.Data/ClusterKit.Data.CRUD/ClusterKit.Data.CRUD.csproj", ProjectDescription.EnProjectType.NugetPackage)
    new ProjectDescription("ClusterKit.Data", "./ClusterKit.Data/ClusterKit.Data/ClusterKit.Data.csproj", ProjectDescription.EnProjectType.NugetPackage, ([|"ClusterKit.Core"; "ClusterKit.Data.CRUD"|]))
    new ProjectDescription("ClusterKit.Data", "./ClusterKit.Data/ClusterKit.Data.TestKit/ClusterKit.Data.TestKit.csproj", ProjectDescription.EnProjectType.NugetPackage, ([|"ClusterKit.Core"; "ClusterKit.Data.CRUD"; "ClusterKit.Data"|]))       
    new ProjectDescription("ClusterKit.Data", "./ClusterKit.Data/ClusterKit.Data.EF/ClusterKit.Data.EF.csproj", ProjectDescription.EnProjectType.NugetPackage, ([|"ClusterKit.Core"; "ClusterKit.Data.CRUD"; "ClusterKit.Data"|]))
    new ProjectDescription("ClusterKit.Data", "./ClusterKit.Data/ClusterKit.Data.EF.TestKit/ClusterKit.Data.EF.TestKit.csproj", ProjectDescription.EnProjectType.NugetPackage, ([|"ClusterKit.Core"; "ClusterKit.Data.CRUD"; "ClusterKit.Data"; "ClusterKit.Data.EF"|]))
    new ProjectDescription("ClusterKit.Data", "./ClusterKit.Data/ClusterKit.Data.EF.Npgsql/ClusterKit.Data.EF.Npgsql.csproj", ProjectDescription.EnProjectType.NugetPackage, ([|"ClusterKit.Core"; "ClusterKit.Data.EF"; "ClusterKit.Data"|]))
    new ProjectDescription("ClusterKit.Data", "./ClusterKit.Data/ClusterKit.Data.Tests/ClusterKit.Data.Tests.csproj", ProjectDescription.EnProjectType.XUnitTests, ([|"ClusterKit.Core"; "ClusterKit.Core.TestKit"; "ClusterKit.Data.CRUD"; "ClusterKit.Data"; "ClusterKit.Data.TestKit"; "ClusterKit.Data.EF"; "ClusterKit.Data.EF.TestKit"; |]))
    ...
    new ProjectDescription("ClusterKit.Web", "./ClusterKit.Web/ClusterKit.Web.Rest/ClusterKit.Web.Rest.csproj", ProjectDescription.EnProjectType.NugetPackage, ([|"ClusterKit.Core"; "ClusterKit.Data.CRUD"; "ClusterKit.Web.Client"; "ClusterKit.Web.Descriptor"; "ClusterKit.Web"|]))
    ...
    new ProjectDescription("ClusterKit.NodeManager", "./ClusterKit.NodeManager/ClusterKit.NodeManager.ConfigurationSource/ClusterKit.NodeManager.ConfigurationSource.csproj", ProjectDescription.EnProjectType.NugetPackage, ([|"ClusterKit.Core"; "ClusterKit.Data.EF"; "ClusterKit.Data"|]))
