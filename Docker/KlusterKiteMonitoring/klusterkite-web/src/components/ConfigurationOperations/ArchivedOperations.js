...
export default class ArchivedOperations extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    <div>
      ...
      {this.props.currentState && this.props.currentState === 'Archived' && this.props.canCreateMigration && !this.state.isChangingState &&
      ...
      {this.props.currentState && this.props.currentState === 'Archived' && this.props.currentMigration &&
