  ...
  render() {
    return (
      <div className="authForm">
        <Form onSubmit={this.submit} className="form-horizontal form-margin" saving={this.props.authorizing}
              disabled={this.props.authorized}
              saved={this.props.authorized} saveError={this.props.authorizationError} buttonText="Login" savedText="Authorized">
          <fieldset>
